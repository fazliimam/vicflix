...
export const TechnosConstant: Skill[] = [
  ...
  { title: TechnosList.Pytorch, logo: 'technos/Pytorch', color: '#FFFFFF', id: nanoid(4) },
  ...
  { title: TechnosList.Beautifulsoup, logo: 'technos/Beautifulsoup', color: '#F7931E', id: nanoid(4) },
  { title: TechnosList.Selenium, logo: 'technos/Selenium', color: '#F7931E', id: nanoid(4) },
